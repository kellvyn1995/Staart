                        ...
                        <?php
                            switch ($_GET['aviso']) {
                                case '01':
                                    ...
                                    echo '<button type="submit" name="acao" value="inicio" >Inicio</button>';
                                    break;
                            case '02':
                            ...
                            case '05':
                                ...
                                break;
                            case '06':
                                echo '<p>Acesso negado usúario não emcontrado.</p>';
                                echo '<a href="../view/login.HTML">Tenta novamente</a>';
                                break;
                                default:
